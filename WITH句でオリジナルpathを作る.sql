...
--------------------------------------------------------------------+------------------------
 ...
 http://www.example.com/list/cd                                     | www.example.com/list
 http://www.example.com/detail?id=1                                 | www.example.com/detail
 http://www.example.com/list/newly                                  | www.example.com/list
 http://www.example.com/list/cd                                     | www.example.com/list
 http://www.example.com/                                            | www.example.com/
 http://www.example.com/detail?id=2                                 | www.example.com/detail
 http://www.example.com/                                            | www.example.com/
 http://www.example.com/list/cd                                     | www.example.com/list
 http://www.example.com/list/dvd                                    | www.example.com/list
 http://www.example.com/detail?id=2                                 | www.example.com/detail
 http://www.example.com/list/newly                                  | www.example.com/list
 http://www.example.com/                                            | www.example.com/
 http://www.example.com/list/dvd?utm_source=yahoo&utm_medium=search | www.example.com/list
